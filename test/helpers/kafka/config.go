...
const (
	...
	clientProperties = `
      ...
      ssl.truststore.location=/var/run/ocp-collector/secrets/kafka-receiver/ca-bundle.jks
	...
	serverProperties = `
      ...
      ssl.keystore.location=/var/run/ocp-collector/secrets/kafka-receiver/server.jks
